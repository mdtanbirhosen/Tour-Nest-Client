...
const PackageDetails = () => {
  ...
  return (
    <div>
      ...
      <section className="pb-10">
        <Title title={`Tour plan`}
        subTitle={'Give days and relevant information'}></Title>
        <TourPlan packageInfo={packageInfo}></TourPlan>
      </section>
      <section className="pb-10">
        <Title title={`All Tour Guide`}
        subTitle={'Click on a tour guide to see details about guide and choose any of guide for your tour'}></Title>
        <AllTourGuide></AllTourGuide>
      </section>
      <section className="pb-10">
        <Title title={`Booking Form`}
        subTitle={'Insert all information for proceed , and make sure you are logged in.'}></Title>
